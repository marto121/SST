...
SELECT Now() AS Log_Date, 'chk_BC_Exists' AS Log_Source, 'No business case for ' || npe_code || ' which is in status '' || npe_status_code || ''' AS Log_Text, 2 AS Log_Type, NPE_History.m_ID
...
WHERE (((Asset_History.m_ID)=-1) AND ((Round(IIf( Asset_History.Book_Value_PM is null ,0,Asset_History.Book_Value_PM)+IIf( Asset_History.Inflows is null ,0,Asset_History.Inflows)+IIf( Asset_History.CAPEX is null ,0,Asset_History.CAPEX)+IIf( Asset_History.Depreciation is null ,0,Asset_History.Depreciation)+IIf( Asset_History.Sales is null ,0,Asset_History.Sales)+IIf( Asset_History.Imp_WB is null ,0,Asset_History.Imp_WB)-IIf( Asset_History.Book_Value is null ,0,Asset_History.Book_Value),0))<>0));

-- 10.04.2018 09:26:44
DROP function if exists chk_BV_Log;
CREATE function chk_BV_Log( p_m_ID integer) RETURNS  void  LANGUAGE 'sql' AS $$
INSERT INTO SST_Log ( Log_Date, Log_Source, Log_Text, Log_Type, Mail_ID )
SELECT Now() AS Log_Date, 'chk_BV_Log' AS Log_Source, 'Book value mismatch for asset ''' || Asset_Code || ' ' || Asset_Name || '''. Book_Value_PM(' || Round(Book_Value_PM,0) || ')+Inflows(' || Round(Inflows,0) || ')+CAPEX(' || Round(CAPEX,0) || ')+Depreciation(' || Round(Depreciation,0) || ')+Sales(' || Round(Sales,0) || ')+Imp_WB(' || Round(Imp_WB,0) || ')<>Book_Value(' || Round(Book_Value,0) || '). The difference isp_ ' || Round(IIf( Asset_History.Book_Value_PM is null ,0,Asset_History.Book_Value_PM)+IIf( Asset_History.Inflows is null ,0,Asset_History.Inflows)+IIf( Asset_History.CAPEX is null ,0,Asset_History.CAPEX)+IIf( Asset_History.Depreciation is null ,0,Asset_History.Depreciation)+IIf( Asset_History.Sales is null ,0,Asset_History.Sales)+IIf( Asset_History.Imp_WB is null ,0,Asset_History.Imp_WB)-IIf( Asset_History.Book_Value is null ,0,Asset_History.Book_Value),0) AS Log_Text, 2 AS Log_Type, Asset_History.m_ID
FROM Assets_List INNER JOIN Asset_History ON Assets_List.ID = Asset_History.Asset_ID
WHERE (((Asset_History.m_ID)=p_m_ID) AND ((Round(IIf( Asset_History.Book_Value_PM is null ,0,Asset_History.Book_Value_PM)+IIf( Asset_History.Inflows is null ,0,Asset_History.Inflows)+IIf( Asset_History.CAPEX is null ,0,Asset_History.CAPEX)+IIf( Asset_History.Depreciation is null ,0,Asset_History.Depreciation)+IIf( Asset_History.Sales is null ,0,Asset_History.Sales)+IIf( Asset_History.Imp_WB is null ,0,Asset_History.Imp_WB)-IIf( Asset_History.Book_Value is null ,0,Asset_History.Book_Value),0))<>0));

$$;
-- 11.04.2018 08:55:48
DROP function if exists chk_Repossession_Exists;
CREATE function chk_Repossession_Exists( p_m_ID integer) RETURNS  void  LANGUAGE 'sql' AS $$
INSERT INTO SST_Log ( Log_Date, Log_Source, Log_Text, Log_Type, Mail_ID )
SELECT Now() AS Log_Date, 'chk_Repossession_Exists' AS Log_Source, 'Incorrect or incomplete Repossession data for asset ''' || Asset_Code || ' ' || Asset_Name || '''.' || IIf(Purchase_Contract_Date Is Null,' Contract Date is not filled-in; ','') || IIf(Purchase_Payment_Date Is Null,' Payment Date is not filled-in; ','') || IIf(Purchase_Contract_Date>Rep_Date,' Contract date is after reporting date;','') || IIf(Purchase_Payment_Date>Rep_Date,' Payment date is after reporting date','') AS Log_Text, 2 AS Log_Type, Asset_History.m_ID
...
WHERE (((Asset_History.m_ID)=p_m_ID) AND ((IIf( Book_Value is null ,0,Book_Value))<>0) AND ((IIf( Purchase_Contract_date is null ,DateSerial(2100,1,1),Purchase_Contract_Date))>Rep_Date)) OR (((Asset_History.m_ID)=p_m_ID) AND ((IIf( Book_Value is null ,0,Book_Value))<>0) AND ((IIf( Purchase_Payment_Date is null ,DateSerial(2100,1,1),Purchase_Payment_Date))>Rep_Date));

$$;
-- 11.04.2018 14:44:50
DROP function if exists chk_Sales;
CREATE function chk_Sales( p_m_ID integer) RETURNS  void  LANGUAGE 'sql' AS $$
INSERT INTO SST_Log ( Log_Date, Log_Source, Log_Text, Log_Type, Mail_ID )
SELECT Now() AS Log_Date, 'chk_Sales' AS Log_Source, 'Incorrect or incomplete Sales data for asset ''' || Asset_Code || ' ' || Asset_Name || '''.' || IIf(Sale_Contract_Date Is Null,' Contract Date is not filled-in; ','') || IIf(Sale_Approval_Date Is Null,' Approval Date is not filled-in; ','') || IIf(Sale_Payment_Date Is Null,' Payment Date is not filled-in; ','') || IIf(Sale_Contract_Date>Rep_Date,' Contract date is after reporting date;','') || IIf(Sale_Approval_Date>Rep_Date,' Approval date is after reporting date','') || IIf(Sale_Payment_Date>Rep_Date,' Payment date is after reporting date','') || IIf( Sale_Book_Value_CCY is null ,'Sales BV not filled-in in Sales sheet','') || IIf(Round(Sale_Book_Value_CCY,0)<>Round(Sales,0),'Sales BV in Sales sheet(' || Round(Sale_Book_Value_CCY,0) || ') is different to Sales BV in Asset_Status (' || -Round(Sales,0) || '.','') AS Log_Text, 2 AS Log_Type, Asset_History.m_ID
...
WHERE (((Asset_History.m_ID)=p_m_ID) AND ((Asset_History.Sales)<>0) AND ((IIf( Sale_Contract_date is null ,DateSerial(2100,1,1),Sale_Contract_Date))>Rep_Date)) OR (((Asset_History.m_ID)=p_m_ID) AND ((Asset_History.Sales)<>0) AND ((IIf( Sale_Approval_Date is null ,DateSerial(2100,1,1),Sale_Approval_Date))>Rep_Date)) OR (((Asset_History.m_ID)=p_m_ID) AND ((Asset_History.Sales)<>0) AND ((IIf( Sale_Payment_Date is null ,DateSerial(2100,1,1),Sale_Payment_Date))>Rep_Date)) OR (((Asset_History.m_ID)=p_m_ID) AND ((Asset_History.Sales)<>0) AND ((Round(IIf( Sale_Book_Value_CCY is null ,0,Sale_Book_Value_CCY),0))<>-Round(Sales,0)) AND ((Asset_Sales.Sale_Payment_Date) Between DateAdd('m',-1,Rep_Date)+1 And Rep_Date));
...
SELECT Max(IIf(Tab.m_id=-1,Tab.Asset_ID,Null)) AS old_Asset_ID, Max(IIf(Tab.m_id<>-1,Tab.Asset_ID,Null)) AS new_Asset_ID, Max(IIf(Tab.m_id=-1,Tab.Asset_Name,Null)) AS old_Asset_Name, Max(IIf(Tab.m_id<>-1,Tab.Asset_Name,Null)) AS new_Asset_Name, Max(IIf(Tab.m_id=-1,Tab.Service,Null)) AS old_Service, Max(IIf(Tab.m_id<>-1,Tab.Service,Null)) AS new_Service, Max(IIf(Tab.m_id=-1,Tab.Winner_Company,Null)) AS old_Winner_Company, Max(IIf(Tab.m_id<>-1,Tab.Winner_Company,Null)) AS new_Winner_Company, Max(IIf(Tab.m_id=-1,Nom_Currencies0.Currency_Code,Null)) AS old_Currency_ID, Max(IIf(Tab.m_id<>-1,Nom_Currencies0.Currency_Code,Null)) AS new_Currency_ID, Max(IIf(Tab.m_id=-1,Tab.Amount_CCY,Null)) AS old_Amount_CCY, Max(IIf(Tab.m_id<>-1,Tab.Amount_CCY,Null)) AS new_Amount_CCY, Max(IIf(Tab.m_id=-1,Tab.Budgeted,Null)) AS old_Budgeted, Max(IIf(Tab.m_id<>-1,Tab.Budgeted,Null)) AS new_Budgeted, Max(IIf(Tab.m_id=-1,Tab.Nr_Participants,Null)) AS old_Nr_Participants, Max(IIf(Tab.m_id<>-1,Tab.Nr_Participants,Null)) AS new_Nr_Participants, Max(IIf(Tab.m_id=-1,Tab.Contract_Date,Null)) AS old_Contract_Date, Max(IIf(Tab.m_id<>-1,Tab.Contract_Date,Null)) AS new_Contract_Date, tab.Rep_Date, tab.RowNum, IIf(Min(Tab.m_ID)>-1,'New','') AS Record_Status
...
$$;
-- 30.04.2018 19:21:26
DROP function if exists ins_Procurement_Actions;
...
SELECT Asset_History.Rep_Date, Min(Asset_History.Rep_Date) AS Period_From, Max(Asset_History.Rep_Date) AS Period_To, Assets_List.Asset_Code, Assets_List.Asset_Name, Assets_List.Asset_Description, Nom_Asset_Owned.Asset_Owned, Max(IIf(rep_date=currmonth,Asset_Status_Code,Null)) AS Status_Code, Nom_Currencies.Currency_Code, Sum(Asset_History.Book_Value_PM) AS SumOfBook_Value_PM, Sum(Inflows/fx_rate_avg) AS Inflows_EUR, Sum(CAPEX/fx_rate_Avg) AS CAPEX_EUR, Sum(Depreciation/fx_rate_avg) AS Depreciation_EUR, Sum(Sales/fx_rate_Avg) AS Sales_EUR, Sum(Imp_WB/FX_Rate_Avg) AS Imp_WB_EUR, Sum(IIf(Rep_Date=CurrMonth,Book_Value/FX_Rate_EOP,0)) AS Book_Value_Eop_EUR, Sum(IIf(Rep_Date=CurrMonth,Book_Value,0)) AS Book_Value_Eop, Sum(Costs/FX_Rate_avg) AS DirectCosts_EUR, Sum(IndirectCosts/FX_Rate_avg) AS IndirectCosts_EUR, Sum(Interest/FX_Rate_avg) AS Interest_EUR, Sum(Income/FX_Rate_avg) AS Income_EUR, Sum(SalesPrice/FX_Rate_avg) AS SalePrice_EUR, Asset_History.Expected_Exit, FX_Rates.FX_Rate_Eop
...
SELECT Legal_Entities.LE_Tgk_Name, Asset_History.Rep_Date, Nom_Asset_Owned.Asset_Owned, Assets_List.Asset_Code, Assets_List.Asset_Name, Nom_Asset_Status.Asset_Status_Code, Asset_History.Book_Value, Book_Value/FX_Rate_EOP AS Book_Value_EUR, FX_Rates.FX_Rate_Eop
FROM (Nom_Asset_Owned INNER JOIN ((NPE_List INNER JOIN (Assets_List INNER JOIN ((Asset_History INNER JOIN Nom_Currencies ON Asset_History.Currency_ID = Nom_Currencies.ID) INNER JOIN FX_Rates ON (FX_Rates.RepDate = Asset_History.Rep_Date) AND (Nom_Currencies.Currency_Code = FX_Rates.CCY_Code)) ON Assets_List.ID = Asset_History.Asset_ID) ON NPE_List.ID = Assets_List.Asset_NPE_ID) INNER JOIN Legal_Entities ON NPE_List.LE_ID = Legal_Entities.ID) ON Nom_Asset_Owned.ID = Assets_List.Asset_Owned) LEFT JOIN Nom_Asset_Status ON Asset_History.Status_Code = Nom_Asset_Status.ID
...
SELECT parent.Asset_Code, IIf(Max(IIf(tab.m_id<>-1,parent.Asset_Name,Null)) Is Null,Max(parent.Asset_Name),Max(IIf(tab.m_id<>-1,parent.Asset_Name,Null))) AS Asset_Name, max(case when tab.m_id=-1 then vwCounterparts0.Descr else null end) AS old_Appraisal_Company_ID, max(case when tab.m_id<>-1 then vwCounterparts0.Descr else null end) AS new_Appraisal_Company_ID, tab.Appraisal_Date, max(case when tab.m_id=-1 then Nom_Currencies1.Currency_Code else null end) AS old_Appraisal_Currency_ID, max(case when tab.m_id<>-1 then Nom_Currencies1.Currency_Code else null end) AS new_Appraisal_Currency_ID, max(case when tab.m_id=-1 then tab.Appraisal_Market_Value_CCY else null end) AS old_Appraisal_Market_Value_CCY, max(case when tab.m_id<>-1 then tab.Appraisal_Market_Value_CCY else null end) AS new_Appraisal_Market_Value_CCY, max(case when tab.m_id=-1 then tab.Appraisal_Market_Value_EUR else null end) AS old_Appraisal_Market_Value_EUR, max(case when tab.m_id<>-1 then tab.Appraisal_Market_Value_EUR else null end) AS new_Appraisal_Market_Value_EUR, max(case when tab.m_id=-1 then tab.Appraisal_Firesale_Value_CCY else null end) AS old_Appraisal_Firesale_Value_CCY, max(case when tab.m_id<>-1 then tab.Appraisal_Firesale_Value_CCY else null end) AS new_Appraisal_Firesale_Value_CCY, max(case when tab.m_id=-1 then tab.Appraisal_Firesale_Value_EUR else null end) AS old_Appraisal_Firesale_Value_EUR, max(case when tab.m_id<>-1 then tab.Appraisal_Firesale_Value_EUR else null end) AS new_Appraisal_Firesale_Value_EUR, max(case when tab.m_id=-1 then tab.Appraisal_Order else null end) AS old_Appraisal_Order, max(case when tab.m_id<>-1 then tab.Appraisal_Order else null end) AS new_Appraisal_Order, iif(min(tab.m_ID)>-1,'New','') AS Record_Status
...
SELECT parent.Asset_Code, IIf(Max(IIf(tab.m_id<>-1,parent.Asset_Name,Null)) Is Null,Max(parent.Asset_Name),Max(IIf(tab.m_id<>-1,parent.Asset_Name,Null))) AS Asset_Name, max(case when tab.m_id=-1 then vwCounterparts0.Descr else null end) AS old_Sale_Counterpart_ID, max(case when tab.m_id<>-1 then vwCounterparts0.Descr else null end) AS new_Sale_Counterpart_ID, max(case when tab.m_id=-1 then tab.Sale_Approval_Date else null end) AS old_Sale_Approval_Date, max(case when tab.m_id<>-1 then tab.Sale_Approval_Date else null end) AS new_Sale_Approval_Date, max(case when tab.m_id=-1 then tab.Sale_Contract_Date else null end) AS old_Sale_Contract_Date, max(case when tab.m_id<>-1 then tab.Sale_Contract_Date else null end) AS new_Sale_Contract_Date, max(case when tab.m_id=-1 then tab.Sale_Transfer_Date else null end) AS old_Sale_Transfer_Date, max(case when tab.m_id<>-1 then tab.Sale_Transfer_Date else null end) AS new_Sale_Transfer_Date, max(case when tab.m_id=-1 then tab.Sale_Payment_Date else null end) AS old_Sale_Payment_Date, max(case when tab.m_id<>-1 then tab.Sale_Payment_Date else null end) AS new_Sale_Payment_Date, max(case when tab.m_id=-1 then tab.Sale_AML_Check_Date else null end) AS old_Sale_AML_Check_Date, max(case when tab.m_id<>-1 then tab.Sale_AML_Check_Date else null end) AS new_Sale_AML_Check_Date, max(case when tab.m_id=-1 then tab.Sale_AML_Pass_Date else null end) AS old_Sale_AML_Pass_Date, max(case when tab.m_id<>-1 then tab.Sale_AML_Pass_Date else null end) AS new_Sale_AML_Pass_Date, max(case when tab.m_id=-1 then Nom_Currencies1.Currency_Code else null end) AS old_Sale_Currency_ID, max(case when tab.m_id<>-1 then Nom_Currencies1.Currency_Code else null end) AS new_Sale_Currency_ID, max(case when tab.m_id=-1 then tab.Sale_ApprovedAmt_CCY else null end) AS old_Sale_ApprovedAmt_CCY, max(case when tab.m_id<>-1 then tab.Sale_ApprovedAmt_CCY else null end) AS new_Sale_ApprovedAmt_CCY, max(case when tab.m_id=-1 then tab.Sale_ApprovedAmt_EUR else null end) AS old_Sale_ApprovedAmt_EUR, max(case when tab.m_id<>-1 then tab.Sale_ApprovedAmt_EUR else null end) AS new_Sale_ApprovedAmt_EUR, max(case when tab.m_id=-1 then tab.Sale_Amount_CCY else null end) AS old_Sale_Amount_CCY, max(case when tab.m_id<>-1 then tab.Sale_Amount_CCY else null end) AS new_Sale_Amount_CCY, max(case when tab.m_id=-1 then tab.Sale_Amount_EUR else null end) AS old_Sale_Amount_EUR, max(case when tab.m_id<>-1 then tab.Sale_Amount_EUR else null end) AS new_Sale_Amount_EUR, max(case when tab.m_id=-1 then tab.Sale_Book_Value_CCY else null end) AS old_Sale_Book_Value_CCY, max(case when tab.m_id<>-1 then tab.Sale_Book_Value_CCY else null end) AS new_Sale_Book_Value_CCY, max(case when tab.m_id=-1 then tab.Sale_Book_Value_EUR else null end) AS old_Sale_Book_Value_EUR, max(case when tab.m_id<>-1 then tab.Sale_Book_Value_EUR else null end) AS new_Sale_Book_Value_EUR, tab.Sale_ID, iif(min(tab.m_ID)>-1,'New','') AS Record_Status
...
$$;
-- 30.04.2018 19:21:26
DROP function if exists sel_Procurement_Actions;
...
UPDATE ((Asset_History AS new_tab INNER JOIN Assets_List AS old_parent ON old_parent.id=new_tab.Asset_ID) INNER JOIN Assets_List AS new_parent ON new_parent.Asset_Code=old_parent.Asset_Code) INNER JOIN Asset_History AS dw_tab ON (dw_tab.Rep_Date=new_tab.Rep_Date) AND (dw_tab.Asset_ID=new_parent.id) SET dw_tab.Status_Code = iif(new_tab.Status_Code is null,dw_tab.Status_Code,new_tab.Status_Code), dw_tab.Currency_ID = iif(new_tab.Currency_ID is null,dw_tab.Currency_ID,new_tab.Currency_ID), dw_tab.Book_Value_PM = iif(new_tab.Book_Value_PM is null,dw_tab.Book_Value_PM,new_tab.Book_Value_PM), dw_tab.Inflows = iif(new_tab.Inflows is null,dw_tab.Inflows,new_tab.Inflows), dw_tab.CAPEX = iif(new_tab.CAPEX is null,dw_tab.CAPEX,new_tab.CAPEX), dw_tab.Depreciation = iif(new_tab.Depreciation is null,dw_tab.Depreciation,new_tab.Depreciation), dw_tab.Sales = iif(new_tab.Sales is null,dw_tab.Sales,new_tab.Sales), dw_tab.Imp_WB = iif(new_tab.Imp_WB is null,dw_tab.Imp_WB,new_tab.Imp_WB), dw_tab.Book_Value = iif(new_tab.Book_Value is null,dw_tab.Book_Value,new_tab.Book_Value), dw_tab.Costs = iif(new_tab.Costs is null,dw_tab.Costs,new_tab.Costs), dw_tab.IndirectCosts = iif(new_tab.IndirectCosts is null,dw_tab.IndirectCosts,new_tab.IndirectCosts), dw_tab.Interest = iif(new_tab.Interest is null,dw_tab.Interest,new_tab.Interest), dw_tab.Income = iif(new_tab.Income is null,dw_tab.Income,new_tab.Income), dw_tab.SalesPrice = iif(new_tab.SalesPrice is null,dw_tab.SalesPrice,new_tab.SalesPrice), dw_tab.Expected_Exit = iif(new_tab.Expected_Exit is null,dw_tab.Expected_Exit,new_tab.Expected_Exit)
WHERE new_tab.m_id = p_m_ID and dw_tab.m_id=-1
 and new_parent.m_id=-1;
...
$$;
-- 30.04.2018 19:21:26
DROP function if exists upd_Procurement_Actions;
CREATE function upd_Procurement_Actions( p_m_ID integer) RETURNS  void  LANGUAGE 'sql' AS $$
UPDATE Procurement_Actions AS new_tab INNER JOIN Procurement_Actions AS dw_tab ON (dw_tab.RowNum=new_tab.RowNum) AND (dw_tab.Rep_LE=new_tab.Rep_LE) AND (dw_tab.Rep_Date=new_tab.Rep_Date) SET dw_tab.Asset_ID = iif(new_tab.Asset_ID is null,dw_tab.Asset_ID,new_tab.Asset_ID), dw_tab.Asset_Name = iif(new_tab.Asset_Name is null,dw_tab.Asset_Name,new_tab.Asset_Name), dw_tab.Service = iif(new_tab.Service is null,dw_tab.Service,new_tab.Service), dw_tab.Winner_Company = iif(new_tab.Winner_Company is null,dw_tab.Winner_Company,new_tab.Winner_Company), dw_tab.Currency_ID = iif(new_tab.Currency_ID is null,dw_tab.Currency_ID,new_tab.Currency_ID), dw_tab.Amount_CCY = iif(new_tab.Amount_CCY is null,dw_tab.Amount_CCY,new_tab.Amount_CCY), dw_tab.Budgeted = iif(new_tab.Budgeted is null,dw_tab.Budgeted,new_tab.Budgeted), dw_tab.Nr_Participants = iif(new_tab.Nr_Participants is null,dw_tab.Nr_Participants,new_tab.Nr_Participants), dw_tab.Contract_Date = iif(new_tab.Contract_Date is null,dw_tab.Contract_Date,new_tab.Contract_Date)
WHERE new_tab.m_id = p_m_ID and dw_tab.m_id=-1;
...
SELECT Assets_List.ID, Switch(IIf( book_value is null ,IIf( Asset_Repossession.Purchase_Price_Net_EUR is null ,2000000,Asset_Repossession.Purchase_Price_Net_EUR),book_value)<1000000,36,IIf( book_value is null ,IIf( Asset_Repossession.Purchase_Price_Net_EUR is null ,2000000,Asset_Repossession.Purchase_Price_Net_EUR),book_value)<1500000,24,1,12) AS AppraisalPeriod
...
GROUP BY Assets_List.ID, Switch(IIf( book_value is null ,IIf( Asset_Repossession.Purchase_Price_Net_EUR is null ,2000000,Asset_Repossession.Purchase_Price_Net_EUR),book_value)<1000000,36,IIf( book_value is null ,IIf( Asset_Repossession.Purchase_Price_Net_EUR is null ,2000000,Asset_Repossession.Purchase_Price_Net_EUR),book_value)<1500000,24,1,12);

-- 17.04.2018 14:00:05
DROP view if exists vw_Appraisals_Exp;
CREATE VIEW vw_Appraisals_Exp AS
SELECT Asset_Appraisals.ID, Asset_Appraisals.Appraisal_Asset_ID, Counterparts.Counterpart_Common_Name AS Appraisal_Company, Asset_Appraisals.Appraisal_Date, Nom_Currencies.Currency_Code, Asset_Appraisals.Appraisal_Market_Value_CCY, Asset_Appraisals.Appraisal_Market_Value_EUR, Asset_Appraisals.Appraisal_Firesale_Value_CCY, Asset_Appraisals.Appraisal_Firesale_Value_EUR, IIf( AppraisalPeriod is null ,Null,DateAdd('m',AppraisalPeriod,Appraisal_Date)) AS Appraisal_Expiration
...
FROM Asset_Appraisals
WHERE (((IIf( Appraisal_Market_Value_CCY is null ,0,Appraisal_Market_Value_CCY)+IIf( Appraisal_Market_Value_EUR is null ,0,Appraisal_Market_Value_EUR)+IIf( Appraisal_Firesale_Value_CCY is null ,0,Appraisal_Firesale_Value_CCY)+IIf( Appraisal_Firesale_Value_EUR is null ,0,Appraisal_Firesale_Value_EUR))<>0) AND ((Asset_Appraisals.m_ID)=-1));
...
SELECT NPE_History.ID, NPE_List.NPE_Code, NPE_List.NPE_Name, Max(Nom_NPE_Status.NPE_Status_Code) AS Status, Max(IIf(npe_history.npe_scenario_id=6,npe_history.npe_rep_date,Null)) AS FC_Rep_Date, NPE_History.NPE_Currency, Sum(IIf(npe_history.npe_scenario_id=11,npe_history.npe_amount_ccy,0)) AS FC_NPE_CCY, Sum(IIf(npe_history.npe_scenario_id=11,npe_history.npe_amount_eur,0)) AS FC_NPE_EUR, NPE_List.NPE_Scenario_ID, Sum(IIf(npe_history.npe_scenario_id=2,npe_history.npe_amount_eur,0)) AS MYP_Original, Sum(IIf(npe_history.npe_scenario_id=3,npe_history.npe_amount_eur,0)) AS MYP_Update, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.npe_amount_ccy,0)) AS Actual_CCY, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.npe_amount_eur,0)) AS Actual_EUR, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.llp_amount_ccy,0)) AS Actual_LLP_CCY, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.llp_amount_eur,0)) AS Actual_LLP_EUR, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.purchase_price_ccy,0)) AS Purchase_Price_CCY, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.Purchase_Price_eur,0)) AS Purchase_Price_EUR
...
SELECT NPE_List.NPE_Code, NPE_List.NPE_Name, Max(Nom_NPE_Status.NPE_Status_Code) AS Status, Max(IIf(npe_history.npe_scenario_id=11,npe_history.npe_rep_date,Null)) AS FC_Rep_Date, NPE_History.NPE_Currency, Sum(IIf(npe_history.npe_scenario_id=11,npe_history.npe_amount_ccy,0)) AS FC_NPE_CCY, Sum(IIf(npe_history.npe_scenario_id=11,npe_history.npe_amount_eur,0)) AS FC_NPE_EUR, NPE_List.NPE_Scenario_ID, Sum(IIf(npe_history.npe_scenario_id=2,npe_history.npe_amount_eur,0)) AS MYP_Original, Sum(IIf(npe_history.npe_scenario_id=3,npe_history.npe_amount_eur,0)) AS MYP_Update, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.npe_amount_ccy,0)) AS Actual_CCY, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.npe_amount_eur,0)) AS Actual_EUR, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.llp_amount_ccy,0)) AS Actual_LLP_CCY, Sum(IIf(npe_history.npe_scenario_id=6,npe_history.llp_amount_eur,0)) AS Actual_LLP_EUR
FROM NPE_List INNER JOIN (Nom_NPE_Status RIGHT JOIN NPE_History ON Nom_NPE_Status.ID = NPE_History.NPE_Status_ID) ON NPE_List.ID = NPE_History.NPE_ID
WHERE (((NPE_History.Rep_Date) In (select currmonth from lastDate)) AND ((NPE_History.m_ID)=-1) AND ((NPE_History.NPE_Scenario_ID) In (2,3,6,11)))
...
FROM (Procurement_Actions LEFT JOIN Nom_Currencies ON Procurement_Actions.Currency_ID = Nom_Currencies.ID) INNER JOIN (Nom_Countries INNER JOIN Legal_Entities ON Nom_Countries.ID = Legal_Entities.LE_Country_ID) ON Procurement_Actions.Rep_LE = Legal_Entities.Tagetik_Code
...
SELECT vw_Curr_Deadlines.CurrMonth, vw_Curr_Deadlines.Tagetik_Code, vw_Curr_Deadlines.LE_Name, Mail_Log.Sender, Max(Mail_Log.mailStatus) AS MaxOfmailStatus, vw_Curr_Deadlines.Send_Date, vw_Curr_Deadlines.Confirm_Date, IIf(mailStatus=1,'Received',IIf(mailStatus=2,'Confirmed','')) AS Status
...
GROUP BY vw_Curr_Deadlines.CurrMonth, vw_Curr_Deadlines.Tagetik_Code, vw_Curr_Deadlines.LE_Name, Mail_Log.Sender, vw_Curr_Deadlines.Send_Date, vw_Curr_Deadlines.Confirm_Date, IIf(mailStatus=1,'Received',IIf(mailStatus=2,'Confirmed',''))
...
WHERE (((Legal_Entities.Tagetik_Code)=IIf( RepLE is null ,Tagetik_Code,RepLE)));
