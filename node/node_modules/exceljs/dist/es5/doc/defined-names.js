...
DefinedNames.prototype = {
  ...
  getFormula: function getFormula(name) {
    return this.formulaMap[name];
  },
  ...
  getRanges: function getRanges(name, matrix) {
    ...
    var formula = this.formulaMap[name];

    if (!matrix) {
      return { name: name, ranges: [], formula: formula };
    }
    ...
    return {
      name: name, ranges: ranges, formula: formula
    };
  },
  ...
  get model() {
    ...
    return _.map(this.matrixMap, function (matrix, name) {
      ...
      return definedName.ranges.length || definedName.formula.length;
    });
  },
  set model(value) {
