...
var utils = module.exports = {
  ...
  dateToExcel: function dateToExcel(d, date1904) {
    return Math.round(25569 + d.getTime() / (24 * 3600 * 1000) - (date1904 ? 1462 : 0) - d.getTimezoneOffset() / 60 / 24,5);
  },
  excelToDate: function excelToDate(v, date1904) {
    var millisecondSinceEpoch = Math.round((v - 25569 + (date1904 ? 1462 : 0)) * 24 * 3600 * 1000 );
    var d = new Date(millisecondSinceEpoch);
    return new Date(millisecondSinceEpoch + d.getTimezoneOffset() * 60 * 1000);
  },
